...
public class ViewPagerAdapter extends PagerAdapter {
    ...
    public Object instantiateItem(@NonNull ViewGroup container, int position) {
       ...
       // Picasso.get().load(SERVER_MEDIA_EVENT_NEWS + items.get(position).getMedia()).into(imageView);
        ...
        Picasso.get().load(SERVER_MEDIA_EVENT_NEWS + items.get(position).getMedia()).into(new Target(){
        ...
        //Toast.makeText(context, "Test   "+items.get(position).getMedia(), Toast.LENGTH_SHORT).show();
